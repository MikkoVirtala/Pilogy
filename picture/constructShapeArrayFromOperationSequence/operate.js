			...
			if (operation.postOperatorOperand === 'line') {
				newShapes.push(
					new Line(
						...
						lineStrokeOpacity,
						lineStrokeWidth,
						selectedAttachmentPoints[i].getNormalAngle(), // lineRotationInDegrees +
				...
				newShapes.push(
					new Rectangle(
						...
						selectedAttachmentPoints[i].getNormalAngle(), // rectangleRotationInDegrees +
						// 	rotationIncrement * (useLoopCounterWithRotationIncrement ? i : 1),
						selectedAttachmentPoints[i],
				...
				newShapes.push(
					new Circle(
						...
						circleStrokeOpacity,
						circleStrokeWidth,
						selectedAttachmentPoints[i].getNormalAngle(), // circleRotationInDegrees +
						// 	rotationIncrement * (useLoopCounterWithRotationIncrement ? i : 1),
						selectedAttachmentPoints[i],
				...
				newShapes.push(
					new Triangle(
						...
						triangleStrokeWidth,
						selectedAttachmentPoints[i].getNormalAngle(), // triangleRotationInDegrees *
